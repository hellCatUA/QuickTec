...
export const TIMELINE_META: Record<string, TimelineMeta> = {
  ...
  time_added: { label: "Punch added by hand", icon: Play, tone: "warning" },
  punch_changed: { label: "Punch changed", icon: ArrowRightLeft, tone: "warning" },
  punch_change_requested: { label: "Punch change requested", icon: Pencil, tone: "warning" },
  punch_change_approved: { label: "Punch change approved", icon: CircleCheck, tone: "success" },
  punch_change_denied: { label: "Punch change denied", icon: Ban, tone: "danger" },
  time_flag_accepted: { label: "Time flag accepted", icon: CircleCheck, tone: "success" },
  time_flag_reopened: { label: "Time flag reopened", icon: Flag, tone: "warning" },
  checkout_prepared: { label: "Checkout prepared", icon: ClipboardCheck, tone: "primary" },
  checkout_cleared: { label: "Prepared checkout cleared", icon: Ban, tone: "warning" },
