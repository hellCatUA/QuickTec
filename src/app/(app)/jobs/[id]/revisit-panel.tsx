...
export function RevisitPanel({
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Schedule a revisit</CardTitle>
        <CardDescription>
          Creates a new job carrying the same internal number with an -R suffix,
          in the month the revisit happens. Site, scope and deliverable rules are
          copied across.
        </CardDescription>
      </CardHeader>
